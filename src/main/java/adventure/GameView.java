...
public class GameView extends JFrame {
    ...
    /**
     * checks for the adventure being null null adventure is caused by the wrong
     * file or errors in json file
     */
    ...
    /**
     * loads the default adventure used for when the loaded adventure is null
     */
    ...
    /**
     * @return the name jpanel this jpanel holds the adventure and player name
     *         JLabel
     */
    ...
    /**
     * @return the play jpanel holds the input and output field
     */
    ...
    /**
     * @return the right panel holds the menu panel and the inventory
     */
    ...
    /**
     * @return the menu panel holds the menu label and all 4 buttons
     */
